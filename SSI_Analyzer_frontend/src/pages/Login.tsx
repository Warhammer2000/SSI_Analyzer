  ...
  return (
    <div className="min-h-screen bg-[#f3f2ef] flex flex-col items-center justify-center p-4">
      ...
      <div className="bg-white p-8 rounded-lg border border-[#e0e0e0] shadow-sm w-full max-w-md">
        <h1 className="text-2xl font-bold text-[#000000e6] mb-2">Sign in</h1>
        <p className="text-[#00000099] mb-6">Track your LinkedIn growth</p>
        ...
        <div className="mt-6 text-center text-sm">
          <span className="text-[#00000099]">Don't have an account? </span>
          <Link to="/signup" className="text-[#0a66c2] font-semibold hover:underline">
            Sign Up
          </Link>
        </div>
      </div>
